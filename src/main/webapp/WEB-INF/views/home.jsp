			...
			<div id="carousel-simple" class="carousel slide " data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="resources/imgs/carousel/vongnhi.jpg" alt="">
					</div>
					<div class="carousel-item">
						<img src="resources/imgs/carousel/chichiemem2.jpg" alt="">
					</div>
					<div class="carousel-item">
						<img src="resources/imgs/carousel/nhabanu.jpg"
							alt="">
					</div>
					<div class="carousel-item">
						<img src="resources/imgs/carousel/sieuluagapsieulay.jpg" alt="">
					</div>
					<div class="carousel-item">
						<img src="resources/imgs/carousel/nguoikien.jpg"
							alt="">
					</div>
					<div class="carousel-item">
						<img src="resources/imgs/carousel/hush.jpg" alt="">
					</div>
