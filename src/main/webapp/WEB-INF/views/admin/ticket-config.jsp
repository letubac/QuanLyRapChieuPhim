...
<h2> Bootstrap Sort Table </h2> -->
	...
	<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5"
		...
		<div class="page-wrapper" style="min-height: 250px;">
			...
			<div class="page-breadcrumb bg-white">
				<div class="row align-items-center">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title">Cấu Hình Giá Vé</h4>
					...
					<div class="col-sm-12">
						<div class="white-box">
							<div class="box-header">
								<div>
									<h3 class="box-title">Cấu Hình Giá Vé</h3>
								</div>
								<div class="btn-add-e">
									<a href="#">
								...
								<table class="table table-striped table-hover" id="sortTable">
									<thead>
										<tr>
											...
											<th class="border-top-0">Mã Loại Vé</th>
											<th class="border-top-0">Ngày Áp Dụng</th>
											<th class="border-top-0">Hành Động</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach var="v" items="${lv}" varStatus="status">
											<input id="id" name="id" type="hidden" th:value="${v.id }" />
											<tr>
												...
												<td><a href="#">
														<button class="button" data-bs-toggle="modal"
															data-bs-target="#t-${v.id }">
															<i class="fa-solid fa-pen-to-square"></i>
														</button>
												</a><a href="#">
														<button class="button" data-bs-toggle="modal"
															data-bs-target="#e-${v.id}">
											...
											<div class="row tm-edit-product-row">
												<div class="col-12">
													<div class="header-add-e">
														<h3 class="header-name-add-e">Thêm Mới Cấu Hình Giá
															Vé</h3>
													</div>
													...
													<form class="container-add-e tm-edit-product-form"
														action="/QuanLyRapChieuPhim/admin/ticket-config/add.htm"
														method="post" modelAttribute="ticketConfig">
														<div class="body-add-e">
															<div class="tieude1-add-e">
																<span class="chitiet-left-add-e">Mã Phim :</span>
																<div class="input-add-e">
																	<select class="input-name-add-e" name="maPhim">
																		<c:forEach var="lp" items="${lp}">
																			<option value=${lp.maPhim }>${lp.maPhim }</option>
															...
															<div class="tieude1-add-e">
																...
																<div class="input-add-e">
																	<select class="input-name-add-e" name="maLV">
																		<c:forEach var="lve" items="${lve}">
																			<option value=${lve.maLV }>${lve.maLV }</option>
															...
															<div class="tieude1-add-e">
																<p class="chitiet-left-add-e">Ngày Áp Dụng</p>
																<form class="input-date">
																	<input type="date" name="ngayApDung" id=""
			...
			<!-- Popup delete ticket-config -->
			<c:forEach var="s" items="${lv}">
				<div class="modal fade" id="e-${s.id}" tabindex="-1" role="dialog"
					aria-hidden="true">
					<div
						...
						<div class="modal-content">
							...
							<form method="post" modelAttribute="nhanVien"
								action="/QuanLyRapChieuPhim/admin/ticket-config/delete/${s.id}.htm">
			...
			<!-- Popup model add employee  -->
			<c:forEach var="v" items="${lv}" varStatus="status">
				<div class="modal fade" id="t-${v.id }" tabindex="-1" role="dialog"
					aria-hidden="true">
					<div class="modal-dialog modal-lg modal-dialog-centered">
						<div class="modal-content">
							<div class="modal-header">
										...
										<div class="col-12">
											<div class="tm-bg-primary-dark tm-block tm-block-h-auto">
												<div class="row tm-edit-product-row">
													<div class="col-12">
														<div class="header-add-e">
															<h3 class="header-name-add-e">Sửa Thông Tin Cấu Hình
																Giá Vé</h3>
														</div>
														...
														<form class="container-add-e tm-edit-product-form"
															action="/QuanLyRapChieuPhim/admin/ticket-config/update/${v.id }.htm"
															method="post" modelAttribute="ticketUpdate">
															<div class="body-add-e">
																<div class="tieude1-add-e">
																	<p class="chitiet-left-add-e">Mã Phim:</p>
																	<div class="input-add-e">
																		<input type="text" name="maPhim"
																			class="input-name-add-e" value=${v.maPhim } readonly />
																	</div>
																</div>
																<div class="tieude1-add-e">
																	<span class="chitiet-left-add-e">Mã Loại Vé:</span>
																...
																<div class="same-add">
																	<div class="detail-info-left">
																		...
																		<form class="input-date">
																			<input type="date" name="ngayApDung" id=""
																				class="input-name-add" value="${v.ngayApDung }"
																				required />
																		</form>
																	</div>
																</div>
