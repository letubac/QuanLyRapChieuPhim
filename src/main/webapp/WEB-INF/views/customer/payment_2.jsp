...
<link rel="stylesheet"
	href="http://localhost:8080/QuanLyRapChieuPhim/resources/css/style_payment.css">
              ...
              doloremque voluptate alias distinctio odit. In nesciunt vero beatae optio velit ?</p>-->
					...
					<div class="confirm-panel-content">
						<div class="panel-qrcode">
							...
							<div class="qr-image">
								<img src="https://www.qrcode-gen.com/images/qrcode-default.png"
									alt=""> <
							</div>
						...
						<div class="panel-info">
							<div>
								Mã Vé: <span class="panel-info-span">${v.maVe }</span>
							</div>
							<div>
								Rạp: <span class="panel-info-span">PTITHCM</span>
							</div>
							<div>
								Phim: <span class="panel-info-span">${lc.dsPhim.tenPhim}</span>
							</div>
							<div>
								Suất Chiếu: <span class="panel-info-span">${lc.gioChieu}:00(${lc.ngayChieu })</span>
							</div>
							<div>
								Giá vé: <span class="panel-info-span">${soGhe.size() * lc.dsPhim.giaVe}</span>
							</div>
